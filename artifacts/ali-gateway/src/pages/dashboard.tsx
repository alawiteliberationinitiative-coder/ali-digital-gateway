    ...
    <div className="min-h-[100dvh] bg-background text-foreground relative overflow-hidden pb-12">
      ...
      <header className="sticky top-0 z-20 bg-background/80 backdrop-blur-md border-b border-border p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <AliEmblem className="w-8 h-8" />
          <span className="font-serif font-bold text-primary tracking-widest text-lg">A.L.I.</span>
        </div>
      ...
      <div className="px-4 pt-6 space-y-6 relative z-10 max-w-md mx-auto">
        ...
        <section className="bg-card border border-border rounded-sm p-5 relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="text-right">
              ...
              <div className="text-sm font-mono text-primary uppercase">{userData.rank} <span className="opacity-50 text-xs">LVL {userData.level}</span></div>
            </div>
          </div>
        ...
        <section className="bg-card border border-border rounded-sm p-5">
          ...
          <div className="mb-6">
            <div className="text-4xl font-mono text-foreground mb-1">{userData.mddBalance.toLocaleString()}</div>
            <div className="text-xs font-mono text-muted-foreground uppercase tracking-wider">Total Balance</div>
          </div>
          ...
          <div className="h-40 w-full ml-[-10px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={mockMddData}>
                ...
                />
                <RechartsTooltip 
                  contentStyle={{ backgroundColor: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: '2px', fontFamily: 'var(--font-mono)', fontSize: '12px' }}
        ...
        <section className="bg-card border border-border rounded-sm p-5 relative overflow-hidden group cursor-pointer hover:border-primary/50 transition-colors">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="px-2 py-1 bg-primary/10 border border-primary/20 rounded-sm text-[10px] font-mono text-primary uppercase">Classified</div>
          </div>
