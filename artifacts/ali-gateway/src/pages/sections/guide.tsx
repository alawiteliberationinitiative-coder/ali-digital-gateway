...
const content: Record<string, { title: string; steps: { num: string; text: string }[] }> = {
  ...
  points: {
    ...
    steps: [
      ...
      { num: "🎯", text: "مسابقة «ادعم واربح طريق النحل»: حتى 325+ نقطة جلسة واحدة مع بونص السلسلة." },
    ],
  },
  ads: {
    ...
    steps: [
      ...
      { num: "🔥", text: "كل إعلان تشاهده أثناء مسابقة «ادعم واربح طريق النحل» يُضاعف نقاط الجلسة." },
