...
export const spaceParticipantsTable = pgTable("ali_space_participants", {
  ...
  unique("ali_space_participants_unique").on(t.spaceId, t.telegramId),
  index("idx_space_participants_space").on(t.spaceId),
]);
...
export const spaceSignalsTable = pgTable("ali_space_signals", {
  ...
  index("idx_space_signals_to").on(t.spaceId, t.toTelegramId, t.processed),
]);
...
export type SpaceParticipant   = typeof spaceParticipantsTable.$inferSelect;
export type SpaceSignal        = typeof spaceSignalsTable.$inferSelect;
